...
and glass to create an abstract yet familiar representation of the space.`,
...

  {
    ...
    subtitle: "audiovisual sketch",
    short_description: "Playhead is a virtual directional microphone that allows users to pick up sound fragments from a distance. Each sound fragment is one second long and part of a music track.",
